...
const Terms = ({ name, email, phone, website }: LegalProps) => (
  <div className='legal responsive-width'>
    <h1 className='legal__header'>Terms and Conditions</h1>
    <p>Last updated: April 29, 2022</p>
    <p>Please read these terms and conditions carefully before using Our Service.</p>
    <h2 className='legal__subheader'>Interpretation and Definitions</h2>
    <h3 className='legal__sub-subheader'>Interpretation</h3>
    <p>
      The words of which the initial letter is capitalized have meanings defined under the
      following conditions. The following definitions shall have the same meaning regardless of
      whether they appear in singular or in plural.
    </p>
    <h3 className='legal__sub-subheader'>Definitions</h3>
    <p>For the purposes of these Terms and Conditions:</p>
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Affiliate</strong> means an entity that controls,
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Country</strong> refers to: Alabama, United States
        </p>
      </li>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Company</strong> (referred to as either &quot;the
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Device</strong> means any device that can access
          the Service such as a computer, a cellphone or a digital tablet.
        </p>
      </li>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Service</strong> refers to the Website.
        </p>
      </li>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Terms and Conditions</strong>
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Third-party Social Media Service</strong> means any
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Website</strong>
          {` refers to ${name}, accessible from `}
          <a
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>You</strong> means the individual accessing or
          using the Service, or the company, or other legal entity on behalf of which such
          individual is accessing or using the Service, as applicable.
        </p>
      </li>
    </ul>
    <h2 className='legal__subheader'>Acknowledgment</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Links to Other Websites</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Termination</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Limitation of Liability</h2>
    <p>
    ...
    <p>
      ...
      may not apply. In these states, each party&apos; liability will be limited to the
      greatest extent permitted by law.
    </p>
    <h2 className='legal__subheader'>
    ...
    <p>
      ...
      be compatible or work with any other software, applications, systems or services, operate
      without interruption, meet any performance or reliability standards or be error free or
      that any errors or defects can or will be corrected.
    </p>
    <p>
      Without limiting the foregoing, neither the Company nor any of the company&apos; provider
    ...
    <h2 className='legal__subheader'>Governing Law</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Disputes Resolution</h2>
    <p>
    ...
    <h2 className='legal__subheader'>For European Union (EU) Users</h2>
    <p>
    ...
    <h2 className='legal__subheader'>United States Legal Compliance</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Severability and Waiver</h2>
    <h2 className='legal__subheader'>Severability</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Changes to These Terms and Conditions</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Contact Us</h2>
