import { LegalProps } from '@/components/legal/Terms';

const PrivacyPolicy = ({ name, email, phone, website }: LegalProps) => (
  <div className='legal responsive-width'>
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Account</strong> means a unique account created for
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Cookies</strong> are small files that are placed on
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Personal Data</strong> is any information that
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Service Provider</strong> means any natural or
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Usage Data</strong> refers to data collected
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Website</strong> refers to {name}, accessible from{' '}
          <a
    ...
    <h2 className='legal__subheader'>Collecting and Using Your Personal Data</h2>
    <h3 className='legal__sub-subheader'>Types of Data Collected</h3>
    <h3 className='legal__sub-subheader'>Personal Data</h3>
    <p>
    ...
    <h3 className='legal__sub-subheader'>Usage Data</h3>
    ...
    <h2 className='legal__subheader'>Tracking Technologies and Cookies</h2>
    <p>
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <strong className='legal__strong'>Cookies or Browser Cookies.</strong> A cookie is a
        ...
        may not be able to use some parts of our Service. Unless you have adjusted Your browser
      ...
      <li className='legal__bullet'>
        <strong className='legal__strong'>Web Beacons.</strong> Certain sections of our Service
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Necessary / Essential Cookies</strong>
        </p>
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Cookies Policy / Notice Acceptance Cookies</strong>
        </p>
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>Functionality Cookies</strong>
        </p>
        <p>Type: Persistent Cookies</p>
        <p>Administered by: Us</p>
        <p>
    ...
    <h2 className='legal__subheader'>Use of Your Personal Data</h2>
    <p>The Company may use Personal Data for the following purposes:</p>
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>To provide and maintain our Service</strong>,
          including to monitor the usage of our Service.
        </p>
      </li>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>To manage Your Account:</strong> to manage Your
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>For the performance of a contract:</strong> the
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>To contact You:</strong> To contact You by email,
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>To provide You</strong> with news, special offers
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>To manage Your requests:</strong> To attend and
          manage Your requests to Us.
        </p>
      </li>
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>For business transfers:</strong> We may use Your
      ...
      <li className='legal__bullet'>
        <p>
          <strong className='legal__strong'>For other purposes</strong>: We may use Your
    ...
    <ul className='legal__list'>
      <li className='legal__bullet'>
        <strong className='legal__strong'>With Service Providers:</strong> We may share Your
        personal information with Service Providers to monitor and analyze the use of our
        Service, to contact You.
      </li>
      <li className='legal__bullet'>
        <strong className='legal__strong'>For business transfers:</strong> We may share or
      ...
      <li className='legal__bullet'>
        <strong className='legal__strong'>With Affiliates:</strong> We may share Your
      ...
      <li className='legal__bullet'>
        <strong className='legal__strong'>With business partners:</strong> We may share Your
        information with Our business partners to offer You certain products, services or
        promotions.
      </li>
      <li className='legal__bullet'>
        <strong className='legal__strong'>With other users:</strong> when You share personal
      ...
      <li className='legal__bullet'>
        <strong className='legal__strong'>With Your consent</strong>: We may disclose Your
        personal information for any other purpose with Your consent.
      </li>
    </ul>
    <h2 className='legal__subheader'>Retention of Your Personal Data</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Transfer of Your Personal Data</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Disclosure of Your Personal Data</h2>
    <h2 className='legal__subheader'>Business Transactions</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Law enforcement</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Other legal requirements</h2>
    <p>
      The Company may disclose Your Personal Data in the good faith belief that such action is
      necessary to:
    </p>
    <ul className='legal__list'>
      <li className='legal__bullet'>Comply with a legal obligation</li>
      <li className='legal__bullet'>
      ...
      <li className='legal__bullet'>Protect against legal liability</li>
    </ul>
    <h2 className='legal__subheader'>Security of Your Personal Data</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Children&apos;s Privacy</h2>
    <p>
    ...
    <h2 className='legal__subheader'>Changes to this Privacy Policy</h2>
    <p>
