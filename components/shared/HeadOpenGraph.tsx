...
const HeadOpenGraph = ({
  ...
  const url = 'https://holamichoacanicecream.com';
  const cannonicalURL = url + asPath;
  const siteTitle = `${title} | Hola Michoacan Ice Cream`;
  ...
  const websiteJson = {
    ...
    publisher: 'Hola Michoacan Ice Cream',
  };
  ...
  return (
    <Head>
      ...
      <meta name='theme-color' content='#d50083' />
